...
new Moonboots({
    moonboots: {
        jsFileName: 'organize-my-life',
        cssFileName: 'organize-my-life',
...
console.log('Organize My Life is running at: http://localhost:' + config.http.port + ' Yep. That\'s pretty awesome.');
